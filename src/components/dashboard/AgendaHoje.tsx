  ...
  return (
    <div className="card p-5">
      ...
      <button
        ...
        className="mt-4 flex w-full items-center justify-center gap-1.5 rounded-xl border border-dashed border-gray-200 py-2.5 text-sm font-medium text-zaz-purple hover:bg-purple-50/50"
      >
